...
function addSampleProjects(target){
	...
	for(var i=0;i<jsonData.length;i++){
	    ...
	    case "Primary Auditory Cortex Network":
                url="http://opensourcebrain.org/projects/acnet2/models?explorer=https%253A%252F%252Fraw.githubusercontent.com%252FOpenSourceBrain%252FACnet2%252Fmaster%252FneuroConstruct%252FgeneratedNeuroML2%252FMediumNet.net.nml";
		iconClass="acnet2SampleThumbnail sampleThumbnail";
		break;
	        
	    case "CA1 Pyramidal Cell":
                url="http://opensourcebrain.org/projects/ca1pyramidalcell/models?explorer=https%253A%252F%252Fraw.githubusercontent.com%252FOpenSourceBrain%252FCA1PyramidalCell%252Fmaster%252FneuroConstruct%252FgeneratedNeuroML2%252FBigCA1.net.nml";
		iconClass="ca1SampleThumbnail sampleThumbnail";
		break;
	        
	    case "Izhikevich Spiking Neuron Model":
                url="http://opensourcebrain.org/projects/izhikevichmodel?explorer=https%253A%252F%252Fraw.githubusercontent.com%252FOpenSourceBrain%252FIzhikevichModel%252Fmaster%252FNeuroML2%252FIzh2007One.net.nml";
		iconClass="izhiSampleThumbnail sampleThumbnail";
		break;
	        
	    case "L23 Cell":
                url="http://opensourcebrain.org/projects/blue-brain-project-showcase/models?explorer=https%253A%252F%252Fraw.githubusercontent.com%252FOpenSourceBrain%252FBlueBrainProjectShowcase%252Fmaster%252FNMC%252FNeuroML2%252FcADpyr229_L23_PC_5ecbf9b163.net.nml";
		iconClass="l23SampleThumbnail sampleThumbnail";
		break;
	        
	    case "Hodgkin-Huxley Neuron":
                url="http://opensourcebrain.org/projects/hodgkin-huxley-tutorial?explorer=https%253A%252F%252Fraw.githubusercontent.com%252Fopenworm%252Fhodgkin_huxley_tutorial%252Fmaster%252FTutorial%252FSource%252FHHCellNetwork.net.nml";
